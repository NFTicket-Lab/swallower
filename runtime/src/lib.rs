...
use frame_support::{traits::EqualPrivilegeOnly, weights::DispatchClass};
use pallet_grandpa::{
...
parameter_types! {
	...
	pub MaximumSchedulerWeight: Weight = RuntimeBlockWeights::get().max_block*80/100;
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, pallet_swallower, Swallower);
		...
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_swallower, Swallower);
